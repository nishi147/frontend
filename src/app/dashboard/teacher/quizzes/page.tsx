        ...
        <DashboardLayout allowedRoles={['teacher', 'admin']}>
            <div className="flex flex-col gap-8">
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div>
                        <h1 className="text-4xl font-black text-gray-800 mb-2">Brain Challenges 🧠</h1>
                        <p className="text-gray-500 font-bold">Create and manage magical quizzes for your space cadets.</p>
                    </div>
                    <Button 
                ...
                {isLoading ? (
                    ...
                    <Card className="p-20 text-center border-dashed border-4 border-gray-200 bg-white/50 rounded-[3rem]">
                        ...
                        <h2 className="text-2xl font-black text-gray-400 mb-4">No challenges yet!</h2>
                        <p className="text-gray-400 font-bold mb-8">Test your students' knowledge with magic quizzes.</p>
                        <Button onClick={() => setShowForm(true)} variant="outline" className="font-black border-secondary-500 text-secondary-600">Create Challenge 🧠</Button>
                    </Card>
                ) : (
                                    ...
                                    <div className="flex flex-col gap-2 pt-4 border-t border-gray-50">
                                        ...
                                        <div className="flex items-center gap-4 mt-2">
                                            <p className="text-xs font-bold text-gray-500 flex items-center gap-1">
                                                <HelpCircle className="w-3 h-3" /> {quiz.questions?.length} Questions
                                            </p>
                                            <p className="text-xs font-bold text-green-500 flex items-center gap-1">
                                                <Award className="w-3 h-3" /> {quiz.passingScore}% to Pass
                                            </p>
                                        </div>
                                    </div>
                                </CardContent>
