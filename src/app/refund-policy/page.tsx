...
import { FileText, ChevronRight, RefreshCw, Clock, Download } from 'lucide-react';
...
* A brief explanation of the reason you are requesting a refund (your feedback helps us improve)
...
* **By the Parent:** If you need to reschedule or pause a course due to unforeseen circumstances, please contact us at least 24 hours before the scheduled class. We will do our best to accommodate makeup sessions.
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-white rounded-[3.5rem] p-8 md:p-20 shadow-sm border border-gray-100">
              <div className="prose prose-xl max-w-none prose-headings:font-black prose-headings:text-gray-800 prose-p:text-gray-600 prose-p:leading-relaxed prose-strong:text-gray-800 prose-li:text-gray-600 font-medium">
