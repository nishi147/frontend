        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-10">
          ...
          <div className="flex flex-col gap-5">
            ...
            <div className="bg-gradient-to-br from-[#6C5CE7] to-[#a29bfe] rounded-2xl p-6 text-white">
              ...
              <p className="text-white/80 font-bold text-sm mb-4">Start your child's learning journey with a free live session. No commitment needed!</p>
              <button 
                onClick={() => window.dispatchEvent(new CustomEvent('open-free-demo-modal'))} 
                className="block w-full text-center py-3 rounded-xl bg-white text-[#6C5CE7] font-black hover:bg-yellow-300 transition-all cursor-pointer border-none outline-none"
              >
                Claim Free Trial
              </button>
            </div>
